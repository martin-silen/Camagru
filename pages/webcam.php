    ...
    <div class="allwebcam">
      <main class="webcamapercu">
        <div class="webcam" id="column1">
          ...
          <p>
            Or<br />
            Upload an image <br /><span id="alinea">(jpeg, png | max 1.5 Mo)</span>
          </p>
...
<!-- Page webcam : possibility to take pictures from a webcam with a choice of 3 superimposable images -->
